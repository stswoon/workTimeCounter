...
const TimerRemoveConfirmationDialog: FC<TimerRemoveConfirmationDialogProps> = (
  props,
) => {
  return (
    <>
      <Dialog open={props.open} onClose={() => props.onClose(false)}>
        ...
        <DialogActions>
          ...
          <Button color="error" onClick={() => props.onClose(true)} autoFocus>
            {strings.removeDialog.okRemoveButton}
          </Button>
        </DialogActions>
      </Dialog>
    </>
